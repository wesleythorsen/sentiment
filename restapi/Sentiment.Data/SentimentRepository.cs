...
namespace Sentiment.Data
{
    public class SentimentRepository : ISentimentRepository
    {
        ...
        public SentimentSeries GetSentimentByConfigId(long configId, TimeSpan groupingInterval, DateTime startDate, DateTime endDate)
        {
        ...
        public SentimentSeries GetSentimentByKeyword(string keyword, TimeSpan groupingInterval, DateTime startDate, DateTime endDate)
        {
